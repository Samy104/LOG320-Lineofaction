...
public class Move {
	...
	// Constructor
	public Move(int fromRowIndex, int fromColumnIndex, int toRowIndex, int toColumnIndex, int overwritedSquare)
	{
		this.fromRowIndex = fromRowIndex;
		this.fromColumnIndex = fromColumnIndex;
		this.toRowIndex = toRowIndex;
		...
		this.overwritedSquare = overwritedSquare;
	}
	...
	public int getOverwritedSquare()
	{
		return this.overwritedSquare;
	}
	
	// Sets the value of the square thas is overwrited by the move
	public void setOverwritedSquare(int value)
	{
		this.overwritedSquare = value;
	}
